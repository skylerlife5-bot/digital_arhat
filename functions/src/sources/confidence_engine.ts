import {UnifiedMandiRate, VerificationStatus} from "./types";
...
function officialSourceBonus(sourceId: string): number {
  ...
  if (sourceId === "lahore_official_market_rates") return 0.24;
  if (sourceId === "karachi_official_price_lists") return 0.24;
  return 0;
}
...
): {score: number; reason: string; verificationStatus: VerificationStatus} {
  let score = 0.45;
