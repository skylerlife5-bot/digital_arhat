import {
  ContributorPenaltyLevel,
  ContributorProfile,
  ContributorType,
  ContributorVerificationStatus,
} from "./types";

export type ContributorProfileDraft = {
...
function maskContact(input: string): string {
...
export function createContributorProfile(draft: ContributorProfileDraft): ContributorProfile {
...
export function toContributorPublicView(profile: ContributorProfile): Record<string, unknown> {
  return {
...
export function applyPenaltyLevel(
